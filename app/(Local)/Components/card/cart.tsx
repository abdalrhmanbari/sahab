...
export default function Cart({
  ...
  return (
    <Link
      href={link}
      className="   h-[18rem] flex flex-row-reverse border border-gray-200 rounded-md "
    >
      <img
        src={data.img}
      ...
      <div className="  w-full py-4 px-4 flex flex-col gap-2">
        ...
        <p className=" text-[#222222]"  dir="ltr">{data.description}</p>
        {/* realEstate */}
        {realEstate == true ? (
          <>
            <span dir="ltr">
        ...
        <span className=" text-[0.9rem] text-[#23262AA3]">
        ...
        <div className=" flex  gap-2 items-center justify-end ">
          <button className=" px-6 py-4 bg-emerald-100 rounded-md font-black text-[0.9rem] flex items-center w-fit gap-2">
            واتساب
            <Image alt="icon" src={whatsapp} className="w-4" />
          </button>
          <button className=" px-6 py-4 bg-blue-100  rounded-md font-black text-[0.9rem] flex items-center w-fit gap-2">
            مكالمة
