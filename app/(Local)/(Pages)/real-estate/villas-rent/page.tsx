...
import { villasRent } from '@/app/(Local)/Utils/Context/context'
...
export default function Villas() {
  return (
    <div className=' flex flex-col items-end gap-4 text-end 2xl:px-40 sm:px-16 px-4'>
        ...
        <h1 className=' text-[#222222]'> فلل للإيجار </h1>
      </span>
      <h1 className='sm:text-2xl text-lg font-semibold mb-2'>فلل للإيجار في سوريا</h1>
