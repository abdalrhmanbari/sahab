...
import { houseRent } from '@/app/(Local)/Utils/Context/context'
...
export default function HousesRent() {
  return (
    <div className=' flex flex-col items-end gap-4 text-end 2xl:px-40 sm:px-16 px-4'>
        ...
        <h1 className=' text-[#222222]'>منازل للإيجار</h1>
      </span>
      <h1 className=' sm:text-2xl text-lg font-semibold mb-2'>منازل للإيجار في سوريا</h1>
    ...
    <div className=' hidden sm:block'>
      ...
      <div className=' bg-blue-100 flex flex-col gap-2 w-[10rem] md:w-[12rem] pe-10  py-8  text-end h-fit  '>
        ...
        <Link href={"/real-estate/houses-rent"} className=' text-[0.8rem] hover:text-[#23262AA3]'>منازل للإيجار</Link>
