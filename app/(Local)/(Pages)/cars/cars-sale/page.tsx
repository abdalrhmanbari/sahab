...
export default function CarsSale() {
  return (
    <div className=' flex flex-col items-end gap-4 text-end 2xl:px-40 sm:px-16 px-4'>
      ...
      <h1 className=' sm:text-2xl text-lg font-semibold mb-2'>سيارات للبيع في سوريا</h1>
      ...
      <div className=' bg-blue-100 flex flex-col gap-2 w-[10rem] md:w-[12rem] pe-10  py-8  text-end h-fit  '>
        ...
        <Link href={"/cars/cars-sale"} className=' text-[0.8rem] hover:text-[#23262AA3]'  >سيارات للبيع</Link>
